...
counting_regions = [
    {
        ...
        "polygon": Polygon([(1245, 1111), (1532, 807), (1228, 520), (941, 824)]),  # Polygon points
        "counts": 0,
        "dragging": False,
    ...
    {
        "name": "YOLOv8 Rectangle Region",
        "polygon": Polygon([(2104.5, 328.5), (2391.5, 24.5), (2695.5, 311.5), (2408.5, 615.5)]),  # Polygon points
        "counts": 0,
        "dragging": False,
    ...
    {
        "name": "YOLOv8 Rectangle Region",
        "polygon": Polygon([(2604.5, 1508.5), (2891.5, 1204.5), (3195.5, 1491.5), (2908.5, 1795.5)]),  # Polygon points
        "counts": 0,
        "dragging": False,
    ...
    {
        "name": "YOLOv8 Rectangle Region",
        "polygon": Polygon([(1309.5, 1862.5), (1596.5, 1558.5), (1900.5, 1845.5), (1613.5, 2149.5)]),  # Polygon points
        "counts": 0,
        "dragging": False,
    ...
    {
        "name": "YOLOv8 Rectangle Region",
        "polygon": Polygon([(1304.5, 428.5), (1591.5, 124.5), (1895.5, 411.5), (1608.5, 715.5)]),  # Polygon points
        "counts": 0,
        "dragging": False,
        "region_color": (255, 255, 0),  # BGR Value
        "text_color": (0, 0, 0),  # Region Text Color
    ...
    {
        "name": "YOLOv8 Rectangle Region",
        "polygon": Polygon([(2550.5, 768.5), (2837.5, 464.5), (3141.5, 751.5), (2854.5, 1055.5)]),  # Polygon points
        "counts": 0,
        "dragging": False,
        "region_color": (255, 255, 0),  # BGR Value
        "text_color": (0, 0, 0),  # Region Text Color
    ...
    {
        "name": "YOLOv8 Rectangle Region",
        "polygon": Polygon([(2255.5, 1867.5), (2542.5, 1563.5), (2846.5, 1850.5), (2559.5, 2154.5)]),  # Polygon points
        "counts": 0,
        "dragging": False,
        "region_color": (255, 255, 0),  # BGR Value
        "text_color": (0, 0, 0),  # Region Text Color
    ...
    {
        "name": "YOLOv8 Rectangle Region",
        "polygon": Polygon([(956.5, 1506.5), (1243.5, 1202.5), (1547.5, 1489.5), (1260.5, 1793.5)]),  # Polygon points
        "counts": 0,
        "dragging": False,
        "region_color": (255, 255, 0),  # BGR Value
        "text_color": (0, 0, 0),  # Region Text Color
